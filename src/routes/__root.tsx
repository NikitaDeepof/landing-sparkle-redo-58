...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "AI-инструмент для продаж в переписке, сеть подрядчиков по трафику и 11 модулей по управлению агентством в creator economy. Три формата наставничества." },
